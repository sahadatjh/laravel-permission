            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{ URL::to('admin/category/create') }}" class="btn btn-success float-right">Create New</a>
                @endif
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                       ...
                       <tr>
                            ...
                            <td>
                              @if (Auth::guard('admin')->user()->can('category.edit'))
                                <a class="btn btn-success text-white" href="{{ route('category.edit', $category->id) }}">Edit</a>
                                @endif
